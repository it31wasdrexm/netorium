...
TMPDIR="${NETORIUM_RELEASE_TEMP_DIR:-${PROJECT_ROOT}/.netorium-release-tmp}"
PIP_CACHE_DIR="${NETORIUM_RELEASE_PIP_CACHE_DIR:-${TMPDIR}/pip-cache}"
PYINSTALLER_CONFIG_DIR="${NETORIUM_RELEASE_PYINSTALLER_CONFIG_DIR:-${TMPDIR}/pyinstaller-cache}"
export TMPDIR PIP_CACHE_DIR PYINSTALLER_CONFIG_DIR

mkdir -p "$TMPDIR" "$PIP_CACHE_DIR" "$PYINSTALLER_CONFIG_DIR"
