...
def test_install_docs_include_download_commands() -> None:
    text = (PROJECT_ROOT / "INSTALL.md").read_text(encoding="utf-8")

    assert "raw.githubusercontent.com/OWNER/REPO/main/install.sh" in text
    assert "raw.githubusercontent.com/OWNER/REPO/main/install.ps1" in text
